...
angular.module('hexaquiz.components.auth', ['ui.router', 'firebase']).config(function () {}).run(function () {});})(window.angular);
(function(angular){
'use strict';
'use strict';
