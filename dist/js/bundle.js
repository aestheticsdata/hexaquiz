...
angular.module('hexaquiz.components', ['hexaquiz.components.auth', 'hexaquiz.components.nav', 'hexaquiz.components.modal']);})(window.angular);
(function(angular){
'use strict';
'use strict';

angular.module('hexaquiz.common', ['ui.router', 'hexaquiz.common.questions', 'hexaquiz.common.score', 'hexaquiz.common.timer']).run(["$state", "$uiRouter", function ($state, $uiRouter) {
...
angular.module('hexaquiz.components.modal', []);})(window.angular);
(function(angular){
'use strict';
'use strict';
...
angular.module('hexaquiz.common.score', ['ui.router']);})(window.angular);
(function(angular){
'use strict';
'use strict';

angular.module('hexaquiz.common.timer', []);})(window.angular);
(function(angular){
'use strict';
'use strict';
...
function EnhancedLog($log) {
    var log = {
        ...
        green: ['background: GreenYellow;       color:black', 'background: Chartreuse;        color:black', 'background: LawnGreen;         color:black', 'background: Lime;              color:black', 'background: LimeGreen;         color:black', 'background: PaleGreen;         color:black', 'background: LightGreen;        color:black', 'background: MediumSpringGreen; color:black', 'background: SpringGreen;       color:black', 'background: MediumSeaGreen;    color:white', 'background: SeaGreen;          color:white', 'background: ForestGreen;       color:white', 'background: DarkGreen;         color:white', 'background: YellowGreen;       color:white', 'background: OliveDrab;         color:white', 'background: Olive;             color:white', 'background: DarkOliveGreen;    color:white', 'background: DarkSeaGreen;      color:white', 'background: LightSeaGreen;     color:white', 'background: DarkCyan;          color:white']
    },
        STYLES = {
        default: '',
...
angular.module('hexaquiz.components.modal').component('warning', warning);})(window.angular);
(function(angular){
'use strict';
'use strict';

WarningModalController.$inject = ["$log", "hlg"];
...
angular.module('hexaquiz.components.modal').controller('WarningModalController', WarningModalController);})(window.angular);
(function(angular){
'use strict';
'use strict';
...
angular.module('hexaquiz.common.questions').component('questions', questions).config(["$stateProvider", function ($stateProvider) {
    $stateProvider.state('questions', {
        ...
        resolve: {
            ...
            questions: ["QuestionsService", "$log", function questions(QuestionsService, $log) {
...
QuestionsController.$inject = ["$state", "QuestionsService", "ScoreService", "$uibModal", "$document", "hlg", "$log"];
...
angular.module('hexaquiz.common.score').component('score', score).config(["$stateProvider", function ($stateProvider) {
    $stateProvider.state('score', {
        parent: 'app',
        url: '/score',
        component: 'score',
        resolve: {
            score: ["ScoreService", function score(ScoreService) {
...
ScoreController.$inject = ["$log", "hlg"];
...
angular.module('hexaquiz.common.score').controller('ScoreController', ScoreController);})(window.angular);
(function(angular){
'use strict';
'use strict';

ScoreService.$inject = ["QuestionsService", "$log"];
...
angular.module('hexaquiz.common.score').factory('ScoreService', ScoreService);})(window.angular);
(function(angular){
'use strict';
'use strict';
...
angular.module('hexaquiz.common.timer').component('timer', timer);})(window.angular);
(function(angular){
'use strict';
'use strict';

TimerController.$inject = ["$interval", "$log", "hlg", "TimerService"];
...
angular.module('hexaquiz.common.timer').controller('TimerController', TimerController);})(window.angular);
(function(angular){
'use strict';
'use strict';

TimerService.$inject = ["$interval", "$window", "$log", "hlg"];
...
angular.module('hexaquiz.common.timer').factory('TimerService', TimerService);})(window.angular);
(function(angular){
'use strict';
'use strict';
...
AuthFormController.$inject = ["$log", "cfpLoadingBar"];
...
LoginController.$inject = ["TextService", "AuthService", "cfpLoadingBar", "$state", "AppStateService", "$log"];
...
angular.module('hexaquiz.templates', []).run(['$templateCache', function ($templateCache) {
  $templateCache.put('./root.html', '<div class="root"><header-bar logged-in="$ctrl.loggedIn" user-name="{{$ctrl.userName}}" on-toggle-logged-out-btn="$ctrl.displayLogOutButton($event)"></header-bar><!--<timer ng-show="$ctrl.showTimer" launch="$ctrl.showTimer"></timer>--><div ui-view on-toggle-logged-out-btn="$ctrl.displayLogOutButton($event)" on-user-name-available="$ctrl.displayUserName($event)" on-launch-timer="$ctrl.launchTimer($event)"></div></div>');
  ...
  $templateCache.put('./questions.html', '<div class="questions"><nav questions="$ctrl.questions" is-prev-disabled="$ctrl.isPrevDisabled" on-nav-click="$ctrl.navTo($event)"></nav><timer></timer><questions-list question="$ctrl.questionsListQuestion" on-radio-changed="$ctrl.changeSelected($event)"></questions-list><questions-ribbon indexes="$ctrl.ribbonIndexes"></questions-ribbon></div>');
  ...
  $templateCache.put('./timer.html', '<div class="timer col-md-12"><div class="container"><div class="counter">{{$ctrl.min}}:{{$ctrl.sec}}</div><div class="caption"><span>QUIZ TIMER</span></div></div></div>');
  ...
  $templateCache.put('./questions-ribbon.html', '<div class="row ribbon"><div class="col-xs-12"><div class="text-center counter-hxf">{{$ctrl.currentQuestionIdx}}/{{$ctrl.totalQuestionIdx}}</div></div></div>');
